...
import { createEmpresasPageJsonLd, empresasPages } from '@/lib/empresas-pages'

const siteUrl = process.env.NEXT_PUBLIC_APP_URL ?? 'https://www.classtrack.academy'
const pageData = empresasPages.refuerzoEscolar
...
const jsonLd = createEmpresasPageJsonLd(pageData, siteUrl)

const AcademiasDeRefuerzoEscolarPage = () => {
  return (
    <>
...
export default AcademiasDeRefuerzoEscolarPage
